(function () {
    var JMS = function (id,rowCount,colCount, minLandMineCount, maxLandMineCount) {
        if (!(this instanceof JMS))
            ...
            this.minLandMineCount = minLandMineCount || 0;//地雷最少个数
            this.maxLandMineCount = maxLandMineCount || 0;//地雷最多个数
            this.arrs = [];//格子对应的数组
            this.beginTime = null;//游戏开始的时间
            this.endTime = null;//游戏结束时间
            this.currentSetpCount = 0;//当前走的步数
            this.endCallBack = null;//游戏结束时的回调行数
            this.landMineCallBack = null;//标记为地雷更新剩余地雷个数的回调行数
